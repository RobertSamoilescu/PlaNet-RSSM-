...
class PlanetTrainer:
    ...
    def collect_episode(
        ...
        hidden_state = torch.zeros(
            1, self.config["model_config"]["hidden_state_size"]
        ).cuda()
    ...
    def fit(self):
        ...
        #             save_models(
        #                 self.models, self.optimizers, best_checkpoint_path
        #             )

        #         # save latest model
        #         save_models(
        #             self.models, self.optimizers, latest_checkpoint_path
        #         )
